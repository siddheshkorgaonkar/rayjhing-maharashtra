...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(a) { "use strict"; var b = a.fn.jquery.split(" ")[0].split("."); if (b[0] < 2 && b[1] < 9 || 1 == b[0] && 9 == b[1] && b[2] < 1) throw new Error("Bootstrap's JavaScript requires jQuery version 1.9.1 or higher") }(jQuery), + function(a) {
    ...
    function b(b) {
        return this.each(function() {
            var d = a(this),
                e = d.data("bs.buttonblue"),
                f = "object" == typeof b && b;
            e || d.data("bs.buttonblue", e = new c(this, f)), "toggle" == b ? e.toggle() : b && e.setState(b)
        })
    }
    ...
    c.VERSION = "3.3.4", c.DEFAULTS = { loadingText: "loading..." }, c.prototype.setState = function(b) {
        ...
        var a = !0,
            b = this.$element.closest('[data-toggle="buttonblues"]');
    ...
    var d = a.fn.buttonblue;
    a.fn.buttonblue = b, a.fn.buttonblue.Constructor = c, a.fn.buttonblue.noConflict = function() { return a.fn.buttonblue = d, this }, a(document).on("click.bs.buttonblue.data-api", '[data-toggle^="buttonblue"]', function(c) {
        var d = a(c.target);
        d.hasClass("btn") || (d = d.closest(".btn")), b.call(d, "toggle"), c.preventDefault()
    }).on("focus.bs.buttonblue.data-api blur.bs.buttonblue.data-api", '[data-toggle^="buttonblue"]', function(b) { a(b.target).closest(".btn").toggleClass("focus", /^focus(in)?$/.test(b.type)) })
}(jQuery), + function(a) {
    "use strict";
